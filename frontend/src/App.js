            ...
            <CardContent className="p-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-600 mb-2">
                  {activeReport === 'profit-loss' && 'تقرير الأرباح والخسائر'}
                  {activeReport === 'balance-sheet' && 'الميزانية العمومية'}
                  {activeReport === 'cash-flow' && 'التدفق النقدي'}
                  {activeReport === 'trends' && 'تحليل الاتجاهات المالية'}
                </h3>
                <p className="text-gray-500">
                  {reportData ? 'البيانات متاحة - سيتم عرض التقرير قريباً' : 'لا توجد بيانات للعرض'}
                </p>
                {reportData && (
                  <div className="mt-4 text-sm text-gray-600">
                    <p>تم تحديث البيانات: {new Date().toLocaleString('ar-SA')}</p>
                  </div>
                )}
              </div>
            </CardContent>
